	...
	<body>
	  ...
	  <%@ include file="/jsp/header.jsp" %>
		<div class="container">
			<div class="row">
				...
				<div style="margin:0 auto;margin-top:10px;width:950px;">
					...
					<table class="table table-bordered">
						<tbody>
							<tr class="warning">
								<th colspan="5">订单编号:${order1.oid} </th>
							</tr>
							<tr class="warning">
								<th>图片</th>
								<th>商品</th>
							...
							<c:forEach items="${order1.list}" var="item">
							  <tr class="active">
				...
				<div style="text-align:right;margin-right:120px;">
					商品金额: <strong style="color:#ff6600;">￥${order1.total }</strong>
				</div>
			...
			<div>
				<hr/>
				<form id="orderForm" action="${pageContext.request.contextPath}/OrderServlet?method=confirmOrder"  method="post" class="form-horizontal" style="margin-top:5px;margin-left:150px;">
					<div class="form-group">
						<label for="username" class="col-sm-1 control-label">地址</label>
						<div class="col-sm-5">
							<input type="text" class="form-control" name="address" id="addre1" placeholder="请输入收货地址">
						</div>
					</div>
					<div class="form-group">
					...
					<p style="text-align:right;margin-right:100px;">
						<a href="javascript:document.getElementById('orderForm').submit();">
							<input type="hidden" name="id" value="${order1.oid}"/>
